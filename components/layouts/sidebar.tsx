                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">SYSTEM</span>
                        </Link>
                        ...
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'user' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/adminstrator/user/table">{t('List')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/adminstrator/user/create">{t('Create')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/adminstrator/user/view">{t('View')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/adminstrator/user/update">{t('Update')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="nav-item">
                                <ul>
                                    {/* <li className="nav-item">
                                        <Link href="/adminstrator/user/view" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <Link href="/adminstrator/role/view" className="group">
                                            <div className="flex items-center">
                                                <IconMenuMailbox className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Role Management')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/apps/permission" className="group">
                                            <div className="flex items-center">
                                                <IconMenuTodo className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Permission')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/apps/navigator" className="group">
                                            <div className="flex items-center">
                                                <IconMenuTodo className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Navigator')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    {/* <li className="nav-item">
                            ...
                            <li className="menu nav-item">
                                <Link href="/sale" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Sale Management')}</span>
                                    </div>
                                </Link>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <Link href="/customer" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Customer Management')}</span>
                                    </div>
                                </Link>
                            </li>
                        </ul>
