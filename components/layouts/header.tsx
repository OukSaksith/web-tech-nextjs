                ...
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="hidden align-middle text-2xl  font-semibold  transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">SYSTEM</span>
                        </Link>
                        <button
                            type="button"
                            ...
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    ...
                                    <li className="border-t border-white-light dark:border-white-light/10">
                                        ...
                                        <Link href="/api/auth/signout" className="!py-3 text-danger">
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Administrator')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className="sub-menu">
                            <li>
                                <Link href="/apps/user">{t('User Management')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/role">{t('Role Management')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/permission">{t('Permission')}</Link>
                            </li>
                            <li>
                                <Link href="/apps/navigator">{t('Navigator')}</Link>
                            </li>
                            {/*<li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Sale')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className="sub-menu">
                            <li>
                                <Link href="/sale">{t('Sale Management')}</Link>
                            </li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Customer')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className="sub-menu">
                            <li>
                                <Link href="/customer">{t('Customer Management')}</Link>
                            </li>
